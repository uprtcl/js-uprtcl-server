    ...
    return [
      {
        ...
        handler: [
          ...
          async (req: Request, res: Response) => {
            ...
            try {
              const data = await this.knownSourcesService.getGeneric(
                inputs.hash,
                inputs.userId
              );
              ...
              console.log(
                '[UPRTCL CONTROLLER] getGeneric - Error',
...

      {
        ...
        handler: [
          ...
          async ({ params, body }: Request, res: Response) => {
            await this.knownSourcesService.addKnownSources(
              params.elementId,
              body
            );
...

      {
        ...
        handler: [
          ...
          async ({ params }: Request, res: Response) => {
            const data = await this.knownSourcesService.getKnownSources(
              params.elementId
            );
            let result: GetResult<string[]> = {
              result: SUCCESS,
